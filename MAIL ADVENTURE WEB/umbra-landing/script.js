...
/* -----------------------------------------------------------------
   AUDIO — assets/audio si existen; si no, Web Audio genera un
...
function startAmbientAudio() {
    ...
    document.removeEventListener("touchstart", startAmbientAudio);
}

document.addEventListener("click", startAmbientAudio);
document.addEventListener("touchstart", startAmbientAudio);